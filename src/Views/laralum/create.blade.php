                        ...
                        <form class="uk-form-stacked" method="POST" action="{{ route('laralum::events.store') }}">
                            ...
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="date" value="{{ old('date') }}" name="date" class="uk-input" type="text" data-large-mode="true" data-large-default="true" data-init-set="false" data-theme="laralum-date" data-format="Y-m-d" data-lang="{{ App::getLocale() }}" placeholder="@lang('laralum_events::general.date_ph')">
                                    </div>
                                </div>
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input value="{{ old('time', "00:00") }}" id="time" name="time" class="uk-input" type="text" placeholder="@lang('laralum_events::general.time_ph')">
                                    </div>
                                </div>
